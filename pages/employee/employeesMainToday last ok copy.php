        ...
        <form method="post" accept-charset="UTF-8">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-3"><label class="form-label">First Name *</label>
              <input type="text" name="FirstName" class="form-control"  value="<?php echo h($editRow['FirstName']); ?>"></div>
            ...
            <div class="col-md-3"><label class="form-label" >National ID</label>
              <input type="text" name="NationalID" class="form-control" required value="<?php echo h($editRow['NationalID']); ?>"></div>
            ...
            <div class="col-md-3"><label class="form-label">Phone 1</label>
              <input type="text" name="Phone1" class="form-control" required value="<?php echo h($editRow['Phone1']); ?>"></div>
            ...
            <div class="col-md-3"><label class="form-label" >DOB</label>
              <input type="date" name="DOB" class="form-control" required value="<?php echo h(substr((string)$editRow['DOB'],0,10)); ?>"></div>
