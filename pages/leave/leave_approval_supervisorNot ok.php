                    ...
                    <div class="section">
                        ...
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <span class="info-value">
                                    <?php echo htmlspecialchars($leave['SupervisorID_admin'] ?? 'Not assigned'); ?>
                                    <?php if ($leave['SupervisorID_admin'] == $supervisorID && $isL1Supervisor): ?>
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">
                                    <?php echo htmlspecialchars($leave['SupervisorID_technical'] ?? 'Not assigned'); ?>
                                    <?php if ($leave['SupervisorID_technical'] == $supervisorID && $isL2Supervisor): ?>
                                        <span class="badge badge-authorized">Your Assignment</span>
                                    <?php endif; ?>
                                </span>
                            </div>
                            <div class="info-item">
                                ...
                                <span class="info-value">
                                    <?php echo htmlspecialchars($leave['SupervisorID_2ndLevel'] ?? 'Not assigned'); ?>
                                    <?php if ($leave['SupervisorID_2ndLevel'] == $supervisorID && $is2ndLevelSupervisor): ?>
                                        <span class="badge badge-authorized">Your Assignment</span>
                                    <?php endif; ?>
                                </span>
                            </div>
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <div class="login-info">
                    <strong>Current Supervisor:</strong> <?php echo htmlspecialchars($supervisorInfo['FullName'] ?? ''); ?> 
                    (<?php echo htmlspecialchars($supervisorInfo['EmployeeCode'] ?? ''); ?>)
            ...
            <div class="content">
                <div class="section">
                    <h2>Pending Leave Applications from Your Team (<?php echo count($pendingLeaves); ?>)</h2>
                            ...
                            <tbody>
                                <?php foreach ($pendingLeaves as $leave): ?>
                                    <tr>
                                        ...
                                        <td><?php echo isset($leave['StartDate']) ? htmlspecialchars(date('d-m-Y', strtotime($leave['StartDate']))) : ''; ?></td>
                                        <td><?php echo isset($leave['EndDate']) ? htmlspecialchars(date('d-m-Y', strtotime($leave['EndDate']))) : ''; ?></td>
                                        <td><?php echo htmlspecialchars($leave['TotalDays'] ?? ''); ?></td>
                                        <td><?php echo isset($leave['AppliedDate']) ? htmlspecialchars(date('d-m-Y H:i', strtotime($leave['AppliedDate']))) : ''; ?></td>
                                        <td>
                                            <?php 
                                            $statusClass = 'status-pending';
                                            $statusText = 'Pending';
